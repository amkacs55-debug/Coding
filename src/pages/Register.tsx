    ...
    <div className="flex-1 flex flex-col items-center justify-center p-4 py-20 bg-slate-50">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-black tracking-tight text-slate-900 mb-2">Шинэ хаяг нээх</h2>
          <p className="text-slate-500 font-medium">Өнөөдрөөс код бичиж эхэлцгээе.</p>
        </div>

        <form onSubmit={handleRegister} className="mt-8 space-y-6 bg-white border border-slate-200 p-8 rounded-3xl shadow-sm">
          {error && (
